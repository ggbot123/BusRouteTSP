...
## 计算连续交叉口输入流量
alpha = 0.8
junctions = {'I1': {'W': [0.8*1593, [0.17, 0.78, 0.05]],
                    'N': [0.8*251, [0.15, 0.75, 0.1]],
                    'S': [0.8*501, [0.55, 0.3, 0.15]],
                    'E': [-1, [0.17, 0.78, 0.05]]
                    },
             'I2': {'W': [-1, [0.17, 0.78, 0.05]],
                    'N': [0.8*494, [0.2, 0.7, 0.1]],
                    'S': [0.8*498, [0.2, 0.7, 0.1]],
                    'E': [-1, [0.17, 0.78, 0.05]]
                    },
             'I3': {'W': [-1, [0.17, 0.78, 0.05]],
                    'N': [0.8*691, [0.2, 0.7, 0.1]],
                    'S': [0.8*538, [0.2, 0.7, 0.1]],
                    'E': [-1, [0.17, 0.78, 0.05]]
                    },
             'I4': {'W': [-1, [0.17, 0.78, 0.05]],
                    'N': [0.8*431, [0.15, 0.75, 0.1]],
                    'S': [0.8*484, [0.15, 0.75, 0.1]],
                    'E': [-1, [0.17, 0.78, 0.05]]
                    },
             'I5': {'W': [-1, [0.17, 0.78, 0.05]],
                    'N': [0.8*515, [0.25, 0.65, 0.1]],
                    'S': [0.8*462, [0.25, 0.65, 0.1]],
                    'E': [0.8*1593, [0.17, 0.78, 0.05]]
                    }
            }
junctions = {'I1': {'W': [alpha*1593, [0.17, 0.78, 0]],
                    'N': [alpha*251, [0.15, 0.75, 0.1]],
                    'S': [alpha*501, [0.55, 0.3, 0.15]],
                    'E': [-1, [0.17, 0.78, 0]]
                    },
             'I2': {'W': [-1, [0.17, 0.78, 0]],
                    'N': [alpha*494, [0.2, 0.7, 0.1]],
                    'S': [alpha*498, [0.2, 0.7, 0.1]],
                    'E': [-1, [0.17, 0.78, 0]]
                    },
             'I3': {'W': [-1, [0.17, 0.78, 0]],
                    'N': [alpha*691, [0.2, 0.7, 0.1]],
                    'S': [alpha*538, [0.2, 0.7, 0.1]],
                    'E': [-1, [0.17, 0.78, 0]]
                    },
             'I4': {'W': [-1, [0.17, 0.78, 0]],
                    'N': [alpha*431, [0.15, 0.75, 0.1]],
                    'S': [alpha*484, [0.15, 0.75, 0.1]],
                    'E': [-1, [0.17, 0.78, 0]]
                    },
             'I5': {'W': [-1, [0.17, 0.78, 0]],
                    'N': [alpha*515, [0.25, 0.65, 0.1]],
                    'S': [alpha*462, [0.25, 0.65, 0.1]],
                    'E': [alpha*1593, [0.17, 0.78, 0]]
                    }
            }
